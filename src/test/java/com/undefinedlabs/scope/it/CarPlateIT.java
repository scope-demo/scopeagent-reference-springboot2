...
public class CarPlateIT {
    ...
    public void should_obtain_not_found_car_plate_by_uuid() {
        ...
        //When
        final CarPlateDTO carPlate = restTemplate.getForObject("http://localhost:" + randomServerPort + "/carplate/"+NOT_FOUND_CAR_UUID+"?q=foobar", CarPlateDTO.class);
    ...
    @Test
    public void should_obtain_internal_server_error() {
        //Given
        final RestTemplate restTemplate = new RestTemplate();

        //When
        final CarPlateDTO carPlate = restTemplate.getForObject("http://localhost:" + randomServerPort + "/carplate/"+ERROR_CAR_UUID+"?q=foobar", CarPlateDTO.class);
